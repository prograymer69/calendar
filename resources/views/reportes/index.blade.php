...
@section('content')
    <div>
        <div class="form-group row">
			<label for="example-text-input" class="col-3 col-form-label">C&eacute;dula</label>
			<div class="col-9">
				<input class="form-control" type="text" name="name">
			</div>
        </div>
        <div class="text-center">
            <button class="btn btn-primary consultar">Consultar</button>
        </div>
    </div>
        
    <div class="content-card control" style="display: none">
        <div class="header">
    ...
    <div class="content-card control estadisticas" style="display: none">
        <div class="header">
            ESTAD&Iacute;STICAS
        </div>
        <div class="body">
